...
table_2_exports_by_goods <- 
  ...
  tab_header(
    title = "Աղյուսակ 2. Հայաստանի արտահանումը ըստ ապրանքախմբերի",
    subtitle = "Տարեկան կտրվածքով"
  ) |> 
  tab_footnote(
    footnote = caption_f("Armstat")
...
<!-- ![](plots/table_2_exports_by_goods.png) -->
...
Ներկայացնենք վերջին շաբաթվա ընթացքում ԶԼՄ հաղորդագորությունները

1. [📺 ՔՆՆԱՐԿՈՒՄ․ Ի՞նչ է կատարվում անշարժ գույքի շուկայում](https://youtu.be/RKO3zfP1hxA)

Այս նյութը դիտել է 16 հազար հոգի։

<a href="https://youtu.be/RKO3zfP1hxA">
  <img src="https://i3.ytimg.com/vi/RKO3zfP1hxA/hqdefault.jpg" alt="YouTube Video" style="width:60%;">
</a>
