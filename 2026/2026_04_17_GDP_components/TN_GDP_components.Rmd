...
legend_data <- 
  tibble(
    x = 0.123, y = c(2.5, 1.5),
    label = c("2024թ․ ՀՆԱ աճը՝ 5.9%", "2025թ․ ՀՆԱ աճը՝ 7.2%")
  )
...
plot_3_gdp_comporation <-
  ...
  geom_point(aes(x = 0.11, y = 2.5), color = "#f95d6a", size = 3) +
  geom_point(aes(x = 0.11, y = 1.5), color = "#005C4B", size = 3) +
  geom_text(
    data = legend_data,
...
mean_growth <- 
  GDP_annual_pct |> 
  summarise(mean_growth = exp(mean(log(1 + GDP_growth))) - 1) |> 
  pull(mean_growth)
...
GDP_annual_pct |>
  ...
  # geom_hline(yintercept = mean_growth * 100, color = new_palette_colors[1], linetype = 2, linewith = 2) +
...
plot_gdp_components_2025 <- 
  ...
  labs(
    ...
    fill = "Ազդեցություն՝",
    linetype = NULL,
    title = "2025թ․. ՀՆԱ-ի աճին նպաստող գործոնները",
...
ggsave("plots/plot_3_gdp_comporation_2025.png", plot_3_gdp_comporation, width = 12, height = 8)
ggsave("plots/plot_gdp_annual_growth_2025.png", plot_gdp_annual_growth, width = 12, height = 8)
ggsave("plots/plot_gdp_quarter_gowth_2025.png", plot_gdp_quarter_gowth, width = 12, height = 8)
ggsave("plots/plot_gdp_components_2024_2025.png", plot_gdp_components_2024, width = 12, height = 8)
ggsave("plots/plot_5_components_dynamics_2025.png", plot_5_components_dynamics, width = 12, height = 8)
...
## 🔢🕵️‍♀️🕳️️ [Շքեղ թվերի ետևում․ Հայաստանի տնտեսական աճի ստվերը](`r newsletter_url`)
...
### 🔢🕵️‍♀️🕳️️  Behind the Impressive Numbers: Shadows in Armenia's Economic Growth
