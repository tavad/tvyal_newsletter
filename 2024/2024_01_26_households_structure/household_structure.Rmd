...
decile_description <-
  ...
  mutate(
    ...
    description_eng = case_when(
      x == 1 ~ paste0("1st decil - less than ", round(deciles2/1000), " thousand drams"),
      x == 10 ~ paste0("10th decil - more than ", round(deciles/1000), " thousand drams"),
      TRUE ~ paste0(toOrdinal(x), " decil - from ", round(deciles/1000), " to ",
...
1. Լիարժեք ընտանիք՝ հարուստ ընտանիք
...
Ինչպես երևում է մինչև 161 հազար դրամ ընդհանուր եկամուտ ստացող առաջին, երկրորդ և երրորդ դեցիլային խմբերի հիմնական դրամական եկամուտը գոյանում է եկնսաթոշակից։*

Տնային տնտեսությունների ամենաաղքատ 10 տոկոսի հիմնական եկամտի աղբյուր կենսաթոշակն է, որը կազմում է մինչև 85 հազար դրամ ստացող տնային տնտեսությունների եկամտի 67 տոկոսը, 12 տոկոսը ընտակեկան նպաստն է, իսկ աշատավարձը՝ ընդամենը 7 տոկոսը։ Նշենք որ այս խմբում մեկ տնային տնտեսության հաշվով կենսաթոշակը կազմում է 28 հազար դրամ։ Սա չի նշանակում որ միջին կենսաթոշակը այս խմբում հավասար է 25 հազար դրամի։ Պարզապես որոշ տնային տնտեսություններ այս խմբում չունեն 63 անց անձանց և այդ տնային տնտեսությունները կենսաթոշակ չեն ստանում։ Նույնը վերաբերում է աշխատավարձից ստցված եկամտին։ Ըստ տնային տնտեսությունների 2022 63-տվյալների բազայի թվականին անց մարդկանց մոտ միջին կենսաթոշակը կազմում է 46 245 դրամ։ Յուրաքանչյուր դեցիլային խմբում, ոչ բոլորն անդամներն են ստանում աշխատավարձ կամ կենսաթոշակ, որի արդյունքում է որ որոշ միջինացված եկամուտներ ցածր են։
...
Ինչքան տնային տնտեսությունը հարուստ է այնքան մեծանում է ինքնազբաղվածությունից կամ բիզնեսից ստացված եկամուտի մանսբաժինը։ Հուշագրավ է այն որ 10-րդ խմբում, որը ներկայացնում են ամենաապահով 10 տոկոսը, աշխատավարձից ստցված եկամուտի տոկոսային կշիռը ավելի ցածր է, քան 9-րդ խմբում։ Ամենաապահով խավը առանձնանում է ինքնազբաղվածների համեմատաբար բարձր տոկոսով։ Նշենք նաև որ այս խմբի եկամտների 1 տոկոսը ձևավորվում է անշարժ գույքի վաճառքից, որը գծապատկերում ներառված է "այլ եկամուտներ" սանդղակում։
