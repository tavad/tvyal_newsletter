...
arm_trade_country |> 
  ...
  geom_hline(yintercept = 0, color = new_palette_colors[1], size = 0.8) +
  scale_x_date(date_breaks = "1 year", date_labels = "%Y") +
  scale_y_continuous(breaks = seq(0, 600, 100), labels = number_format()) +
  ...
  theme(
    plot.margin = margin(-135, 100, 10, 10),
    plot.title = element_text(size = 28, vjust = -23),
    plot.subtitle = element_text(vjust = -52),
...
ggsave("plots/tmp_plot.png", ggplot2::last_plot(), width = 12, height = 8)
```
