...
plot_4_wages <- 
  ...
  labs(
    ...
    caption = caption_f(source = "Armstat", suffix_text = "\nԱշխատավարձը ներկայացված է կումուլատիվ հարթեցված, աշխատավարձի ամսական տվյալները բարակ գծով են ներկայացված")
  ) +
  theme(
...
GDP_quarter <- read_csv("../2024_09_02_GDP_components/GDP_quarter_tidy.csv")
