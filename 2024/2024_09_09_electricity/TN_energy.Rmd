...
```{r plot6, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 8}
electricity_in_NACE_plot
```

Գծապատկեր 6.

```{r plot7, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 8}
yerevan_map_plot
```
...
***Թավադյան, Աղ․Ա․ (2024)․ էլեկտրիկ Հայաստան․ էլեկտրականության արտադրության և արտահանման կրճատում [Electric Armenia: Reduction in Electricity Production and Exports]․ Tvyal.com հարթակ [Tvyal.com platform], 09-09-2024․ https://www.tvyal.com/newsletter/2024/2024_09_09***
