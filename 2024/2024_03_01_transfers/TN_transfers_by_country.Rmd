...
gt_table_transfers <- 
  ...
  cols_label(
    year = "Year",
    K_USD_Inflow = "Million USD",
    pct_change_Inflow = "growth %",
    K_USD_Outflow = "Million USD",
    pct_change_Outflow = "growth %",
    `K_USD_Net inflow` = "Million USD",
  ...
  tab_footnote(
    footnote = paste0(caption_eng, "    |    Data Source: cba")
  )
...
*Աղյուսակ 1.* ՀՀ բանկային համակարգի միջոցով կատարված դրամական փոխանցումներ (ամսական կտրվածքով, մլն ԱՄՆ դոլար)։
...
Այս վերլուծությունը առկա է նաև [մեր կայքեջում](https://www.tvyal.com/newsletter/2024/2024_03_01), այս վերլուծության կոդը դրված է նաև [Github-ում](https://github.com/tavad/tvyal_newsletter)։
