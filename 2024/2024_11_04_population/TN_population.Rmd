...
knitr::knit_hooks$set(plot = function(x, options) {
  base_url = "https://raw.githubusercontent.com/tavad/tvyal_newsletter/"
  if(grepl("^https?://", x)) {
    # If already a URL, use as is
    sprintf('<img src="%s" class="img-fluid">', x)
  } else {
    # Otherwise, construct the full GitHub URL
    sprintf('<img src="%s%s" class="img-fluid">', base_url, x)
  }
})
...
<img src="https://raw.githubusercontent.com/tavad/tvyal_newsletter/refs/heads/main/2024/2024_11_04_population/plots/plot_fertility_change.png" alt="Fertility Change Plot">
