...
plot_1_wage_change_main <- 
  ...
  geom_text(
    data = tibble(
      ...
      label = "Եկամտային խմբերի միջին աշխատավարձը\n2024թ․ օգոստոսին", color = ""
    ),
...
lognormal_params_return <- 
  function(
    adjusted_prices = FALSE, type = "Total", return_db = FALSE,
...
>
>1. [👛💨💰 Դատարկ գրպաններ, բարձր աշխատավարձր](ttps://www.tvyal.com/newsletter/2024/2024_08_12)
...
- Գծապատկերներ 4-ում և 5-ում լոգնորմալ բաշխման ենթադրությունը կարող է կատարելապես չարտացոլել աշխատավարձերի փաստացի բաշխումը
