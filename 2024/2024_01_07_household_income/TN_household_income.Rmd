...
household_change_18_22_plot <- 
  ...
  labs(
    ...
    x = NULL,
    fill = NULL,
    title = "Հայաստանի տնային տնտեսությունների եկամուտների փոփոխությունը 2018-ից 2022 թվականներին",
...
household_pct_change_plot_2 <-
  ...
  labs(
    x = "դրամ",
    y = NULL,
    title = "Որքա՞ն է Հայաստանի ընտանիքների ամսական եկամուտը, այլընտրանքային հայացք",
