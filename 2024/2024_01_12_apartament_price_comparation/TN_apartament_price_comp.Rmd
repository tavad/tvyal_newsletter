...
Ստորև ներկայացված է նաև տվյալ տարածաշրջանի ամենահանրաժան կամ պոպուլյար քաղաքները ըստ Numbeo․com կայքում  Ներկայացված գրառումներումների քանակի։
...
Երևանը զբաղեցնում է 11-րդ տեղը ըստ գրառումների քանակի և առաջին տեղը ըստ նույն որակը ապահովելու ապրուստի ծախսերի։ Ներկայացված տվյալները նախանշում են որ այստեղ առկա է որոշակի անհավասարակշռություն, որը առաջացել է Ռուսաստանի դեմ պատժամիջոցներից և դեպի Հայաստան համեմատաբար մեծ քանակությամբ ՌԴ քաղաքացիների և կապիտալի ներհոսքից։ Այպիսի ներքոսը չի կարող ունենալ շարունակական բնույթ, որը արդեն իսկ [երևում է տվյալներով (տես՝ Գծապատկեր 2 և 3, Հայաստան կատարված դրամական փոխանցումներ)](https://www.tvyal.com/newsletter/2023_10_16)։ Այս անհավասարակշռությունը ունի որոշակի վտանգներ։ Եթե ՌԴ քաղաքացիները Հայաստանում երկարատև չհաստատվեն և դեպի Ռուսաստանի կապիտալի ներհոսքը վերականգնվի, ([որի նախանշանները արդեն առկա են](https://www.tvyal.com/newsletter/2023_10_23)) ապա Հայաստանում գները կարող են ընկանել՝ հատկապես վարձակալության և վաճառքի, որը տնտեսական աճի տեսանկյունից կունենա բացասական հետևանք, քանզի Հայաստանտան մտած կապիտալը հիմնականում ներդրվում է շինարարության մեջ։
